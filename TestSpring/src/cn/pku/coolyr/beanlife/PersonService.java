...
public class PersonService implements BeanNameAware, BeanFactoryAware, ApplicationContextAware,InitializingBean 
{
	...
	//实现BeanNameAware接口
	// 1.该方法可以给arg0表示正在被实例化得bean id
	public void setBeanName(String arg0)
	{
		// TODO Auto-generated method stub
		System.out.println("setBeanName -->被调用 " + arg0);

	}

	//实现BeanFactoryAware接口
	// 2.该方法可以传递beanFactroy
	public void setBeanFactory(BeanFactory arg0) throws BeansException
	{
		// TODO Auto-generated method stub
		System.out.println("setBeanFactory -->被调用" + arg0);
	}

	//实现ApplicationContextAware接口
	//3. 该方法传递ApplicationContext
	public void setApplicationContext(ApplicationContext arg0) throws BeansException
	{
		// TODO Auto-generated method stub
		System.out.println("setApplicationContext-->被调用" + arg0);
